...
export const msgZap = `Olá!! Gostaria de marcar uma avaliação com o Doutor Henrique Mota.`;
    ...
    <Container>
      <InformationsStack direction="column">
        ...
        {/* <CallText variant="h3" color="white">
          Recupere-se <span>Sem Sair de Casa</span>! Fisioterapia Home Care Para
          Você
        </CallText>
      ...
      <MobileInformations>
        ...
        <InnerMobileContainer>
          <Logo
            src="/images/logo-black.svg"
            alt="Henrique Fisioterapia"
            onClick={() => router.push("/")}
          />
          <CallText variant="h3" color="white">
            Recupere-se <span>Sem Sair de Casa</span>! Fisioterapia Home Care
            Para Você
          </CallText>
